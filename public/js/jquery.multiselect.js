  ...
  function getjQueryFromElement(elem) {
     ...
     */
     _buildButton: function() {
       ...
       var $button = (this.$button = $(document.createElement('button')))
         .addClass('ui-multiselect ui-widget ui-state-default ui-default-btn-theme ui-corner-all'
   ...
   _create: function() {
      ...
      var $header = ( this.$header = $( document.createElement('div') ) )
            .addClass('ui-multiselect-header ui-widget-header bg-transparent border-0 p-0 ui-corner-all ui-helper-clearfix')
      ...
      var $menu = ( this.$menu = $( document.createElement('div') ) )
            .addClass('ui-multiselect-menu ui-widget ui-widget-content ui-theme-widget-content ui-corner-all'
