...
<div class="container-fluid topbarCustomPadding">
    ...
    <div class="page-title d-flex mb-3 justify-content-bentween">
        <h3 class="title fw-bold m-0">Add SKU</h3>
    ...
    <div class="inner-page-content mb-4 ">
        <div class="main-grid-container ">					
                        <div class="returnback-heading px-3 py-2 d-flex align-items-center mb-3 mt-2">
                            ...
                            <span class="fs-6 text-black fw-normal ">Add SKU</span>
                        </div>
                        <div class="main-form-container px-md-5 px-3">
                            <h6 class="title small fw-bold mb-4 text-uppercase">SKU Information:</h6>
                            <form class="main-form" action="{{route('skus.store')}}" method="POST" id="userForm" >
                            @csrf
                                <div class="row">
                                    <div class="col-md-7 col-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-select form-select-sm form-single-select defaultselect @error('master_sku_id') is-invalid @enderror"
                                                        ...
                                                        data-initialized="false">
                                                        @foreach($MasterSKU as $MasterSKU)
                                                            <option value="{{ $MasterSKU->id }}" >
                                                                {{ $MasterSKU->master_sku_name }}
                                                            </option>
                                                        @endforeach
                                                </select>
                                                @error('master_sku_id')
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('sku_name') is-invalid @enderror" id="sku_name" value="" name="sku_name"  />
                                            @error('sku_name')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('sku_company_code') is-invalid @enderror" id="sku_company_code" value="" name="sku_company_code" />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('pack_type') is-invalid @enderror" id="pack_type" value="" name="pack_type" />
                                            @error('pack_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('variant') is-invalid @enderror" id="variant" value="" name="variant" />
                                            @error('variant')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('pack_size') is-invalid @enderror" id="pack_size" value="" name="pack_size" />
                                            @error('pack_size')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <button type="submit" class="btn btn-primary btn-primary-gradient text-capitalize px-md-5 px-4" onclick="defaultAlert()">Add SKU </button>
                                            </div>
                                        </div>
