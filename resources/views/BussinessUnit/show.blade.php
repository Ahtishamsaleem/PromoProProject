...
@section('title')Show BussinessUnits @endsection
...
<div class="container-fluid topbarCustomPadding">
    ...
    <div class="page-title d-flex mb-3 justify-content-bentween">
        <h3 class="title fw-bold m-0">Show BussinessUnits</h3>
    ...
    <div class="inner-page-content mb-4 ">
        <div class="main-grid-container ">					
                        <div class="returnback-heading px-3 py-2 d-flex align-items-center mb-3 mt-2">
                            ...
                            <span class="fs-6 text-black fw-normal ">Show BussinessUnits</span>
                        </div>
                            ...
                            <h6 class="title small fw-bold mb-4 text-uppercase">BussinessUnits Information:</h6>
                                <div class="row">
                                    <div class="col-md-7 col-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <label for="" class="form-label small">Bussiness Unit Company Code</label>
                                            </div>
                                            <div class="col-md-7">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <label for="" class="form-label small">Status:</label>
                                            </div>
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('status') is-invalid @enderror" id="status" value="{{$BussinessUnits->status}}" name="status"  />
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
