...
@section('title')Create BussinessUnits @endsection
    ...
    <main class="main-content">
        ...
        <div class="container-fluid topbarCustomPadding">
            ...
            <div class="page-title d-flex mb-3 justify-content-bentween">
                <h3 class="title fw-bold m-0">Create BussinessUnits</h3>
                        ...
                        <form class="main-form" action="{{ route('business-units.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-md-7 col-12">
                                    ...
                                    <div class="row align-items-center mb-3">
                                        <div class="col-md-5">
                                            <label for="business_unit_name" class="form-label small">Business Unit
                                                Name:</label>
                                        </div>
                                        <div class="col-md-7">
                                            <input type="text"
                                                   class="form-control form-control-sm @error('business_unit_name') is-invalid @enderror"
                                                   id="business_unit_name" value="{{ old('business_unit_name') }}"
                                    ...
                                    <div class="row align-items-center mb-3">
                                        <div class="col-md-5">
                                            <label for="company_address" class="form-label small">Business Company
                                                Code</label>
                                        </div>
                                        <div class="col-md-7">
                                            <input type="text"
                                                   ...
                                                   value="{{ old('business_unit_company_code') }}"
