...
@section('title')Edit BussinessUnits @endsection
...
<div class="container-fluid topbarCustomPadding">
    ...
    <div class="page-title d-flex mb-3 justify-content-bentween">
        <h3 class="title fw-bold m-0">Edit BussinessUnits</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-7 col-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <label for="addManufacturer" class="form-label small">Manufacturer :</label>
                                            </div>
                                            <div class="col-md-7">
                                                <select class="form-select form-select-sm form-single-select defaultselect @error('manufacturer_id') is-invalid @enderror"
                                                        id="manufacturer_id" name="manufacturer_id" size="5" data-initialized="false">
                                                        <option value="{{ $BussinessUnits->manufacturer->id }}" {{($BussinessUnits->manufacturer->id) ? 'Selected' : ''}} >
                                                            {{  $BussinessUnits->manufacturer->manufacturer_name  }}
                                                        </option>
                                                </select>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <label for="" class="form-label small">Business Unit Name:</label>
                                            </div>
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('business_unit_name') is-invalid @enderror" id="business_unit_name" value="{{ $BussinessUnits->business_unit_name }}" name="business_unit_name"  />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <label for="" class="form-label small">Business Company Code</label>
                                            </div>
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('business_unit_company_code') is-invalid @enderror" id="business_unit_company_code" value="{{$BussinessUnits->business_unit_company_code}}" name="business_unit_company_code" />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-select form-select-sm @error('status') is-invalid @enderror" id="status" name="status">
                                                    <option value="active" {{ ($BussinessUnits->status == 'active') ? 'Selected' : '' }}>Active</option>
                                                    <option value="inactive" {{ ($BussinessUnits->status == 'inactive') ? 'Selected' : '' }}>Inactive</option>
                                                </select>
                                                @error('status')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <button type="submit" class="btn btn-primary btn-primary-gradient text-capitalize px-md-5 px-4" onclick="defaultAlert()">Update BussinessUnits </button>
                                            </div>
                                        </div>
