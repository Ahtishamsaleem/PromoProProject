...
<div class="container-fluid topbarCustomPadding">
    ...
    <div class="page-title d-flex mb-3 justify-content-bentween">
        <h3 class="title fw-bold m-0">Add Manufacturer</h3>
    ...
    <div class="inner-page-content mb-4 ">
        <div class="main-grid-container ">					
                        <div class="returnback-heading px-3 py-2 d-flex align-items-center mb-3 mt-2">
                            ...
                            <span class="fs-6 text-black fw-normal ">Add Manufacturer</span>
                        </div>
                        <div class="main-form-container px-md-5 px-3">
                            <h6 class="title small fw-bold mb-4 text-uppercase">Manufacturer Information:</h6>
                            <form class="main-form" action="{{route('manufacturers.store')}}" method="POST" id="userForm" >
                            @csrf
                                <div class="row">
                                    <div class="col-md-7 col-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('manufacturer_name') is-invalid @enderror" id="manufacturer_name" value="" name="manufacturer_name"  />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('company_address') is-invalid @enderror" id="company_address" value="" name="company_address" />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('contact_person') is-invalid @enderror" id="contact_person" value="" name="contact_person"  />
                                        ...
                                        <div class="row align-items-center mb-3">
                                            ...
                                            <div class="col-md-7">
                                            <input type="text" class="form-control form-control-sm @error('email_address') is-invalid @enderror" id="email_address" value="" name="email_address" />
                                            @error('email_address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            </div>
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <button type="submit" class="btn btn-primary btn-primary-gradient text-capitalize px-md-5 px-4" onclick="defaultAlert()">Add Manufacturer </button>
                                            </div>
                                        </div>
