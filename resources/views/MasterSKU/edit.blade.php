    ...
    <div class="inner-page-content mb-4 ">
        <div class="main-grid-container ">					
                        ...
                        <div class="main-form-container px-md-5 px-3">
                            ...
                            <form class="main-form" action="{{route('master-skus.update',$MasterSKU->id)}}" method="POST" id="userForm" >
                            @csrf
                            @method('PUT')
                                <div class="row">
                                    <div class="col-md-7 col-12">
                                        ...
                                        <div class="row align-items-center mb-3">
                                            <div class="col-md-5">
                                                <button type="submit" class="btn btn-primary btn-primary-gradient text-capitalize px-md-5 px-4" onclick="defaultAlert()">Update MasterSKU</button>
                                            </div>
                                        </div>
