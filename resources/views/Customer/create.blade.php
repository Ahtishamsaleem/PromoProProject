...
<main class="main-content">
    <div class="container-fluid topbarCustomPadding">
        <div class="page-title d-flex mb-3 justify-content-bentween">
            <h3 class="title fw-bold m-0">Add Customer</h3>
        ...
        <div class="inner-page-content mb-4">
            <div class="main-grid-container">
                <div class="returnback-heading px-3 py-2 d-flex align-items-center mb-3 mt-2">
                    ...
                    <span class="fs-6 text-black fw-normal">Add Customer</span>
                </div>

                <div class="main-form-container px-md-5 px-3">
                    <h6 class="title small fw-bold mb-4 text-uppercase">Customer Information:</h6>
                    <form class="main-form" action="{{ route('customers.store') }}" method="POST" id="customerForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-7 col-12">
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('customer_code') is-invalid @enderror" id="customer_code" name="customer_code" value="{{ old('customer_code') }}" required>
                                        @error('customer_code')
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('customer_name') is-invalid @enderror" id="customer_name" name="customer_name" value="{{ old('customer_name') }}" required>
                                        @error('customer_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('customer_company_code') is-invalid @enderror" id="customer_company_code" name="customer_company_code" value="{{ old('customer_company_code') }}" required>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <select class="form-select form-select-sm @error('customer_channel') is-invalid @enderror" id="customer_channel" name="customer_channel" required>
                                            <option value="channel1" {{ old('customer_channel') == 'channel1' ? 'selected' : '' }}>Channel 1</option>
                                            <option value="channel2" {{ old('customer_channel') == 'channel2' ? 'selected' : '' }}>Channel 2</option>
                                            <option value="channel3" {{ old('customer_channel') == 'channel3' ? 'selected' : '' }}>Channel 3</option>
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <select class="form-select form-select-sm @error('customer_sub_channel') is-invalid @enderror" id="customer_sub_channel" name="customer_sub_channel" required>
                                            <option value="subchannel1" {{ old('customer_sub_channel') == 'subchannel1' ? 'selected' : '' }}>Sub Channel 1</option>
                                            <option value="subchannel2" {{ old('customer_sub_channel') == 'subchannel2' ? 'selected' : '' }}>Sub Channel 2</option>
                                            <option value="subchannel3" {{ old('customer_sub_channel') == 'subchannel3' ? 'selected' : '' }}>Sub Channel 3</option>
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('customer_address') is-invalid @enderror" id="customer_address" name="customer_address" value="{{ old('customer_address') }}" required>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('contact_person') is-invalid @enderror" id="contact_person" name="contact_person" value="{{ old('contact_person') }}">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('contact_number') is-invalid @enderror" id="contact_number" name="contact_number" value="{{ old('contact_number') }}">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control form-control-sm @error('cnic') is-invalid @enderror" id="cnic" name="cnic" value="{{ old('cnic') }}">
                                        @error('cnic')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <input type="date" class="form-control form-control-sm @error('cnic_expiry') is-invalid @enderror" id="cnic_expiry" name="cnic_expiry" value="{{ old('cnic_expiry') }}">
                                        @error('cnic_expiry')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row align-items-center mb-3 mt-4">
                                    <div class="col-md-5">
                                        <button type="submit" class="btn btn-primary btn-primary-gradient text-uppercase px-md-5 px-4">Add Customer</button>
                                    </div>
                                </div>
                            </div>
                        </div>
