...
<main class="main-content">
    <div class="container-fluid topbarCustomPadding">
        <div class="page-title d-flex mb-3 justify-content-bentween">
            <h3 class="title fw-bold m-0">Update Customer</h3>
        ...
        <div class="inner-page-content mb-4">
            <div class="main-grid-container">
                <div class="returnback-heading px-3 py-2 d-flex align-items-center mb-3 mt-2">
                    ...
                    <span class="fs-6 text-black fw-normal">Update Customer</span>
                </div>

                <div class="main-form-container px-md-5 px-3">
                    <h6 class="title small fw-bold mb-4 text-uppercase">Customer Information:</h6>
                    <form class="main-form" action="{{ route('customers.update',$Customer->id) }}" method="POST" id="customerForm">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-7 col-12">
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <select class="form-select form-select-sm @error('customer_channel') is-invalid @enderror" id="customer_channel" name="customer_channel" required>
                                            <option value="channel1" {{ $Customer->customer_channel == 'channel1' ? 'selected' : '' }}>Channel 1</option>
                                            <option value="channel2" {{ $Customer->customer_channel == 'channel2' ? 'selected' : '' }}>Channel 2</option>
                                            <option value="channel3" {{ $Customer->customer_channel == 'channel3' ? 'selected' : '' }}>Channel 3</option>
                                        </select>
                                ...
                                <div class="row align-items-center mb-3">
                                    ...
                                    <div class="col-md-7">
                                        <select class="form-select form-select-sm @error('customer_sub_channel') is-invalid @enderror" id="customer_sub_channel" name="customer_sub_channel" required>
                                            <option value="subchannel1" {{ $Customer->customer_sub_channel == 'subchannel1' ? 'selected' : '' }}>Sub Channel 1</option>
                                            <option value="subchannel2" {{ $Customer->customer_sub_channel == 'subchannel2' ? 'selected' : '' }}>Sub Channel 2</option>
                                            <option value="subchannel3" {{ $Customer->customer_sub_channel == 'subchannel3' ? 'selected' : '' }}>Sub Channel 3</option>
                                        </select>
                                ...
                                <div class="row align-items-center mb-3 mt-4">
                                    <div class="col-md-5">
                                        <button type="submit" class="btn btn-primary btn-primary-gradient text-uppercase px-md-5 px-4">Update Customer</button>
                                    </div>
                                </div>
                            </div>
                        </div>
