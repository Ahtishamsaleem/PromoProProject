            ...
            <div class="inner-page-content mb-4">
                <div class="main-grid-container ">
                    ...
                    <div class="main-form-container px-md-5 px-3">
                        ...
                        <form class="main-form" action="{{ route('brands.store') }}" method="POST" id="userForm">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-7">
                                            <select class="form-select form-select-sm form-single-select defaultselect @error('business_unit_id') is-invalid @enderror"
                                                    ...
                                                    @foreach($BusinessUnit as $Business)
                                                        <option value="{{ $Business->id }}">
                                                            {{ $Business->business_unit_name }}
                                                        </option>
                                                        @endforeach
                                            </select>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        <div class="col-md-5">
                                            <button type="submit"
                                                    ...
                                                    onclick="defaultAlert()">Add Brand
                                            </button>
                                        </div>
                                    </div>
