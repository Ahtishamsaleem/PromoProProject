...
{{-- page title --}}
@section('title','Assgin User Permission')
    ...
    <div class="container-fluid topbarCustomPadding">
        ...
        <nav class="theme-breadcrumbs d-inline-block rounded mt-4 mb-3 bg-transparent p-0" aria-label="breadcrumb">
            <ol class="breadcrumb m-0">
                <li class="breadcrumb-item active"><a href="{{route('permissions.index')}}"><i
                            class="icon-bold-profile-2user1 me-1"></i>Users Permission</a></li>
            </ol>
        </nav>
        <!-- PAGE TITLE -->
        <div class="page-title d-flex mb-3 justify-content-bentween">
            <h3 class="title fw-bold m-0">Users Permission</h3>
                        ...
                        <ul class="nav nav-tabs nav-tabs-default mb-3 border-bottom" id="productTabsContainer"
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="distributors-tab" data-bs-toggle="tab"
                                    ...
                                    aria-controls="distributors-tab-pane" aria-selected="true">Users Permissions
                                </button>
                            </li>
                        ...
                        <div class="tab-pane fade show active" id="distributors-tab-pane" role="tabpanel"
                            ...
                            <div class="grid-container">
                                <div class="add-new-sku-buttons px-3 mb-3">
                                    <a href="{{url('permissions/create')}}" class="btn btn-sm px-3 btn-primary me-2">Add Permission</a>
                                </div>
                                <!-- GRID TABLE -->
                                    ...
                                    @foreach ($permissions as $item)
                                        <tr>
                                            ...
                                            @if(auth()->user()->hasRole('Admin'))    
                                                <a href="{{route('permissions.edit', $item->id )}}" class="btn-flat action-report-btn edit-record-btn p-0 mx-2 addUrl tooltipped-top" title="Edit"><i class="fa-solid fa-pen-to-square fa-1x display-flex align-items-center justify-content-center"></i></a>
                                        
                                                <!-- <button href="{{url('permissions/'.$item->id.' /destroy' )}}" class="btn-flat action-report-btn delete-report-btn p-0 mx-2 blue-text darken-1 tooltipped-top" ><i class="demo-icon sp-delete-filled fa-1x display-flex align-items-center justify-content-center"></i></button> -->
                                            @endif
                                            </td>
                                        </tr>
                                        @endforeach
